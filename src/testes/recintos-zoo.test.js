...
describe('Recintos do Zoologico', () => {
    ...
    test('Deve encontrar o recinto correto para 1 hipopótamo', () => {

        const resultado = new RecintosZoo().analisaRecintos('HIPOPÓTAMO', 1);
        expect(resultado.erro).toBeFalsy();
    ...
    test('Não deve encontrar o recinto floresta para 1 macaco', () => {
